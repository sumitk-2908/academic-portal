  ...
  return (
    <Toast.Provider swipeDirection="right">
      ...
      <Toast.Root
        ...
        className="flex flex-col gap-1 rounded-xl border border-[#E5E7EB] bg-white p-4 shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full dark:border-[#1F2A44] dark:bg-[#111827]"
      >
        ...
        <Toast.Description className="text-xs text-[#64748B] dark:text-[#94A3B8]">
          {toast.message}
        </Toast.Description>
      </Toast.Root>
